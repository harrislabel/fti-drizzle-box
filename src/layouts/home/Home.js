...
import fti_logo from '../../FTI-consulting-logo-blog.png'
        ...
        <div className="pure-g">
          <div className="pure-u-1-1 header">
           <div className='listView'>
            ...
            <img className="pure-img" src={fti_logo} alt="fti-logo"/>
            </div>
            <h1>FTI Consulting - Drizzle Examples</h1>
          ...
          <div className="pure-u-1-1">
            ...
            <p><strong>Total Supply</strong>: <ContractData contract="HarrisCoin" method="totalSupply" methodArgs={[{from: this.props.accounts[0]}]} /> <ContractData contract="HarrisCoin" method="symbol" hideIndicator /></p>
            <p><strong>My Balance</strong>: <ContractData contract="HarrisCoin" method="balanceOf" methodArgs={[this.props.accounts[0]]} /></p>
            <h3>Send Tokens</h3>
            <ContractForm contract="HarrisCoin" method="transfer" labels={['To Address', 'Amount to Send']} />
