...
class Home extends Component {
  ...
  handleSendTokens() {
    this.contracts.HarrisCoin.methods.transfer(this.state.tokenRecipientAddress, this.state.tokenTransferAmount).send()
  }
  ...
  render() {
    ...
    // HarrisCoin Vars
    var tokenSymbol = this.props.drizzleStatus.initialized ? this.contracts.HarrisCoin.methods.symbol.data() : ''
    var tokenSupply = this.props.drizzleStatus.initialized ? this.contracts.HarrisCoin.methods.totalSupply.data() : 'Loading...'
    var tokenBalance = this.props.drizzleStatus.initialized ? this.contracts.HarrisCoin.methods.balanceOf.data(this.props.accounts[0]) : 'Loading...'
